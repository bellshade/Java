...
Java adalah bahasa pemrograman multifungsi dengan tipe _compiled language_. Artinya, kode yang ditulis dalam Java harus dikompilasi atau diubah terlebih dahulu menjadi file _binary_ yang dapat dimengerti oleh komputer. 
...
- **Garbage Collection**. _Garbage Collection_ (pengumpulan sampah otomatis), memiliki fasilitas pengaturan penggunaan memori secara otomatis sehingga _developer_ tidak perlu melakukan pengaturan memori secara langsung seperti halnya dalam bahasa C++ yang dipakai secara luas.
...
| :-----: | :----------------------------: | :-----------------------------------------------------------------------------------------------: | :-----------------------------------: | :---------------------------------------------: |
|   01    | Pendahuluan Pemrograman dan Java |        Memahami program dasar Java         | [Video](https://youtu.be/uHyfQV0kbgo) |     [Materi](src/main/java/bellshade/learn/basic/HelloWorld.java)      |
|   02    | Variabel dan Tipe Data |        Memahami apa itu variabel dan tipe data di Java         | [Video](https://youtu.be/ddK6hExKhmM) |     [Materi](src/main/java/bellshade/learn/basic/TipeData)      |
|   03    | Data Casting |        Memahami data casting pada sebuah variabel di Java         | [Video](https://youtu.be/IRis_1jMi1w) |     [Materi](src/main/java/bellshade/learn/basic/DataCasting)      |
|   04    | Operator Aritmatika |        Memahami operator perhitungan aritmatika dalam Java         | [Video](https://youtu.be/FlbBdWUC0YU) |     [Materi](src/main/java/bellshade/learn/basic/Operator/Aritmatika/Aritmatika.java)      |
|   05    | Operator Komparasi |        Memahami operator perbandingan dalam Java         | [Video](https://youtu.be/KiQDo3yZDnI) |     [Materi](src/main/java/bellshade/learn/basic/Operator/Komparasi/Comparison.java)      |
|   06    | Operator Boolean |        Memahami operator logika (boolean) dalam Java         | [Video](https://youtu.be/wOnpqaWVM3E) |     [Materi](src/main/java/bellshade/learn/basic/Operator/Logika/Logical.java)      |
|   07    | Struktur Kontrol (If-Else) |        Memahami pengkondisian atau struktur kontrol if-else dalam Java         | [Video](https://youtu.be/492A2poEoow) |     [Materi](src/main/java/bellshade/learn/basic/StrukturKontrol/Percabangan/IfElse/IfElse.java)      |
|   08    | Struktur Kontrol (Switch-Case) |        Memahami pengkondisian atau struktur kontrol switch-case dalam Java         | [Video](https://youtu.be/_OwCDThM3EI) |     [Materi](src/main/java/bellshade/learn/basic/StrukturKontrol/SwitchCase/SwitchJava.java)      |
|   09    | Perulangan atau Looping (While) |        Memahami perulangan while dalam Java         | [Video](https://youtu.be/KcsFEZerRDk) |     [Materi](src/main/java/bellshade/learn/basic/Looping/While/WhileLooping.java)      |
|   10    | Perulangan atau Looping (Do-While) |        Memahami perulangan do-while dalam Java         | [Video](https://youtu.be/E9khhPRn8aQ) |     [Materi](src/main/java/bellshade/learn/basic/Looping/DoWhile/DoWhile.java)      |
|   11    | Perulangan atau Looping (For) |        Memahami perulangan for dalam Java         | [Video](https://youtu.be/OAiZZqiSzxo) |     [Materi](src/main/java/bellshade/learn/basic/Looping/For/ForStatement.java)      |
|   12    | Rekursif  |        Memahami rekursif dalam Java         | [Video](https://youtu.be/wdrSmK18nj4) |     [Materi](src/main/java/bellshade/learn/basic/Recursive/Recursive.java)      |
|   13    | Array |        Memahami array dalam Java         | [Video](https://youtu.be/Oa4FvgsCByw) |     [Materi](src/main/java/bellshade/learn/basic/Array/BasicArray/BasicArray.java)      |
|   14    | Array Multi Dimensi |        Memahami array multi dimensi dalam Java         | [Video](https://youtu.be/RN-ZVxdSWSM) |     [Materi](src/main/java/bellshade/learn/basic/Array/MultiDimentionalArray/MultidimensionalArray.java)      |
|   15    | String |        Memahami string dalam Java         | [Video](https://youtu.be/BAtdw48XTMc) |     [Materi](src/main/java/bellshade/learn/basic/String/StringJava.java)      |
|   16    | String Method |        Memahami berbagai metode string dalam Java         | [Video](https://youtu.be/BAtdw48XTMc) |     [Materi](src/main/java/bellshade/learn/basic/String/StringJavaMethod.java)      |
...
Mulailah belajar konsep dan pemrograman Java dengan dasar-dasar _[Object-Oriented Programming](src/main/java/bellshade/learn/intermediate/object_oriented_programming/oop_basic)_.

Apabila kalian telah mempelajari tingkat dasar _Object-Oriented Programming_ (Pemrograman Berorientasi Objek), maka selanjutnya kalian bisa mempelajari tingkat [lanjutan](src/main/java/bellshade/learn/intermediate/object_oriented_programming/oop_intermediate).
...
- [Lambda Expression](src/main/java/bellshade/learn/intermediate/JavaLambdaExpressions) 
- [Image Processing](src/main/java/bellshade/learn/advanced/ImageProcessing/ColoredImageGrayScale/Programnya.java) 
- [Java GUI](src/main/java/bellshade/learn/advanced/JavaGUI)
...
- Java JDK (Java Development Kit) [di sini](https://www.oracle.com/java/technologies/downloads/). 
- Java JRE (Java Runtime Environment) [di sini](https://www.java.com/en/download/manual.jsp).

Java JDK termasuk Java SE (Standard Edition), yang berarti Java edisi biasa/_standard_ yang paling banyak dipakai saat ini. Jika kalian belum mengetahui apa saja jenis-jenis _**Java Edition**_, berikut kami jabarkan secara singkat 😁

- **JavaFX** = Edisi Java yang secara khusus dipakai untuk pembuatan aplikasi _desktop_ berbasis grafis (GUI).
- **Java EE** = _Enterprise Edition_, Edisi Java untuk kelas perusahaan, mencakup fitur _advanced_ seperti _distributed computing_.
- **Java ME** = _Micro Edition_, Edisi Java untuk perangkat _embedded_ (perangkat kecil dengan memori terbatas) seperti TV, _micro-controller_, sensor, dan lain-lain.
- **Java CDK** = _Card Development Kit_, merupakan bagian dari _platform_ Java yang ditujukan untuk _smart card_.

Untuk melakukan kompilasi, buka terminal pada direktori kode yang ingin kalian _compile_, lalu jalankan perintah berikut di CMD/terminal/bash.
...
- [Java Basics](src/main/java/bellshade/learn/basic)
- [Lanjutan Java (Intermediate)](src/main/java/bellshade/learn/intermediate)
- [Lanjutan Java (Advanced)](src/main/java/bellshade/learn/advanced)
- [Algoritma Java](src/main/java/bellshade/algorithm)
- [Struktur Data Java](src/main/java/bellshade/algorithm/datastructure)
- [Utilitas pada Java](src/main/java/bellshade/utilities)
- [Java Object-Oriented Programming](src/main/java/bellshade/learn/intermediate/object_oriented_programming)

## 🤩 Ayo Ikut Kami dan Berkontribusi! 🤩

Bantuan kalian diperlukan untuk Bellshade agar dapat membantu masyarakat Indonesia untuk belajar _programming_.

> "Dengan Bellshade, aku bisa jadi jago ngoding! Terima kasih Bellshade! :smiley:"

Kami sangat senang bila kalian ingin berkontribusi di repositori **Java** ini. Sebelum itu, silakan baca terlebih dahulu [peraturan dan pedoman](CONTRIBUTING.md) yang telah kami siapkan. Terima kasih!
